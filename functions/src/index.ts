...
export const getPriceRecommendation = functions.https.onCall(async (data, context) => {
  try {
...
export const getDemandForecast = functions.https.onCall(async (data, context) => {
  try {
...
export const matchBulkOrder = functions.https.onCall(async (data, context) => {
...
export const optimizeDeliveryRoute = functions.https.onCall(async (data, context) => {
