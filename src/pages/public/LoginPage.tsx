    ...
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center space-y-2 text-xs text-slate-600">
          ...
          <div className="pt-2 border-t border-slate-200/60 flex items-center justify-center gap-3 text-[11px] text-slate-500">
            <span>Specialized Portals:</span>
            <Link to="/admin/login" className="text-purple-700 font-semibold hover:underline">
              Admin Sign-in
            </Link>
            <span>•</span>
            <Link to="/logistics/login" className="text-amber-700 font-semibold hover:underline">
              Fleet Partner Sign-in
            </Link>
          </div>
        </div>
      </div>
